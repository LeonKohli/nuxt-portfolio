...
<template>
  <section class="relative flex items-center justify-center h-screen">
    <div class="w-10/12 md:w-8/12 mx-auto max-w-[110rem]">
      ...
      <div class="flex h-[100vh] items-center justify-center relative overflow-visible">
        <!-- Main Content -->
    ...
    <!-- Scroll Arrow -->
    <button 
      class="absolute transition-all duration-300 -translate-x-1/2 opacity-0 bottom-8 left-1/2 animate-fade-in hover:-translate-y-1"
